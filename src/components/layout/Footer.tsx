...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-slate-800 bg-slate-950 text-white overflow-hidden">
      ...
      <div className="container-site relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 py-16 sm:py-20 px-4 sm:px-8 lg:px-12">
        {/* Column 1: Brand & Delaware Office */}
        <div className="space-y-4">
          <Link href={`/${lang}`} className="inline-flex items-center gap-2.5 transition-opacity hover:opacity-90" aria-label="PontLook home">
            <Image src="/PontLook-Logo-White.png" alt="PontLook GCC Corporate Training Matchmaking Logo" width={44} height={44} className="object-contain" />
        ...
        <nav aria-label="Footer: platform" className="space-y-4">
          ...
          <ul className="space-y-2.5 text-sm font-medium text-slate-400">
            <li><Link href={`/${lang}/who-we-are`} className="hover:text-white transition-colors">{dict.nav.who_we_are}</Link></li>
            <li><Link href={`/${lang}/for-providers`} className="hover:text-white transition-colors">{dict.nav.for_providers}</Link></li>
            <li><Link href={`/${lang}/find-training`} className="hover:text-white transition-colors">{dict.nav.find_training}</Link></li>
            <li><Link href={`/${lang}/faq`} className="hover:text-white transition-colors">{dict.nav.faq}</Link></li>
            <li><a href="https://blog.pontlook.com" className="hover:text-white transition-colors inline-flex items-center gap-1" target="_blank" rel="noopener noreferrer">{dict.nav.blog}</a></li>
          </ul>
        </nav>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2.5 text-sm font-medium text-slate-400">
            <li className="flex items-center gap-2.5">
              ...
              <a href="mailto:contact@pontlook.com" className="hover:text-white transition-colors">
                contact@pontlook.com
              </a>
            </li>
            <li className="flex items-center gap-2.5">
              <Linkedin size={15} className="text-accent shrink-0" />
              <a href="https://www.linkedin.com/company/pontlook/" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
                LinkedIn
              </a>
            </li>
