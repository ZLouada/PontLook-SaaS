...
export default function Footer() {
  ...
  return (
    <footer data-nav-dark="true" className="relative bg-[#020617] text-slate-400 overflow-hidden">
      {/* 1. HORIZON BRAND LOCKUP (PRE-FOOTER ELEMENT) */}
      <div className="relative pt-0 pb-16 sm:pb-20 lg:pb-24 border-t border-white/10 overflow-hidden">
        ...
        <div className="container-site relative z-20 px-4 sm:px-8 lg:px-12 mx-auto">
          <div className="bg-[#0B132B]/85 backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-10 max-w-2xl mx-auto shadow-2xl relative z-10 -mt-10 text-center flex flex-col items-center gap-6 transform-gpu">
      ...
      <div className="bg-[#020617] text-slate-400 border-t border-white/10 pt-16 pb-12 px-6 lg:px-12">
        ...
        <div className="container-site border-t border-white/10 mt-12 pt-8 mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-400 text-center sm:text-start">
          <p>
