...
export default function Card({
  ...
  return (
    <m.div
      ...
      className={`relative rounded-2xl bg-slate-900/60 backdrop-blur-xl border border-white/10 p-6 sm:p-8 text-white shadow-2xl transition-all duration-300 transform-gpu will-change-transform ${
        accentBorder
