...
export default function FinalCta() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-50 text-slate-900 py-28 lg:py-40 border-t border-slate-200/80">
      {/* Ambient Mesh Glow */}
      ...
      <div className="container-site relative z-10 px-6 sm:px-8 lg:px-12 text-center max-w-5xl mx-auto">
        <Reveal>
          ...
          <h2 className="mx-auto max-w-4xl text-3xl font-serif font-normal text-slate-900 sm:text-5xl lg:text-6xl tracking-tight leading-[1.12]">
