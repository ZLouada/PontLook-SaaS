            ...
            return (
              ...
              >
                <m.div
                  ...
                  className="flex flex-col lg:flex-row items-center gap-6 sm:gap-10 lg:gap-16 bg-white/90 backdrop-blur-md rounded-3xl p-5 sm:p-8 lg:p-14 border border-slate-200/80 shadow-xl hover:border-accent/40 hover:shadow-2xl transition-all duration-300 relative z-20"
                >
                  {/* Step Number Circle */}
                  ...
                  <div className="flex-1 w-full flex justify-center lg:justify-end">
                    <div className="w-full max-w-[420px] aspect-[4/3] rounded-2xl bg-gradient-to-br from-slate-50 to-accent/5 border border-slate-200/60 flex items-center justify-center p-4 sm:p-6 relative overflow-hidden shadow-inner">
                      {s.mockup}
                    </div>
                  </div>
                </m.div>
