...
`;
  ...
  return (
    <m.div
      ...
      className="space-y-8"
    >
      <div className="rounded-3xl border border-emerald-500/30 bg-gradient-to-b from-emerald-950/40 to-slate-900/60 p-6 text-center sm:p-8 backdrop-blur-xl">
        <div className="inline-flex items-center gap-2.5 rounded-full border border-emerald-500/30 bg-slate-900/80 px-4 py-1.5 shadow-sm">
        ...
        <div className="mt-8 grid gap-4 text-start sm:grid-cols-3">
          <div className="relative rounded-2xl border border-white/10 bg-slate-900/80 backdrop-blur-xl p-5 shadow-sm">
          ...
          <div className="relative rounded-2xl border border-white/10 bg-slate-900/80 backdrop-blur-xl p-5 shadow-sm">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-900/40 text-emerald-400">
              <MailCheck size={20} />
            </div>
            <div className="mt-3">
      ...
      <div className="rounded-3xl border border-white/10 bg-slate-900/60 backdrop-blur-xl p-6 shadow-xl sm:p-7">
        <div className="flex flex-col items-start justify-between gap-5 sm:flex-row sm:items-center">
          <div className="flex items-start gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-blue-900/40 text-blue-400">
              <FileText size={24} />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="rounded-full bg-blue-900/60 border border-blue-500/30 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-blue-300">
          ...
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-white px-5 py-3.5 text-xs font-bold text-slate-950 shadow-xl transition-all hover:bg-slate-100 active:scale-[0.99] sm:w-auto"
          >
            {downloading ? (
      ...
      <div className="rounded-3xl border border-white/10 bg-slate-900/60 backdrop-blur-xl p-6 sm:p-7">
        <h3 className="font-heading text-sm font-semibold uppercase tracking-wider text-slate-400">
          Submitted Request Scope
        </h3>

        <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-xl border border-white/10 bg-slate-800/60 p-3.5 shadow-sm">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
        ...
        <div className="flex items-center gap-4 text-xs text-slate-400">
          ...
          <Link
            href="/contact"
            className="font-semibold text-slate-200 underline hover:text-blue-400"
          >
