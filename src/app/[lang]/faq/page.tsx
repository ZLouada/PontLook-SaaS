...
export default async function FAQPage({ params }: { params: Promise<{ lang: Locale }> | { lang: Locale } }) {
  ...
  return (
    <>
        ...
        <div className="container-site max-w-4xl relative z-10 text-center mx-auto">
          <Reveal>
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl text-white font-heading">
              {isAr ? (
                <>
                  الأسئلة الأكثر <span className="text-blue-400">شيوعاً وتكراراً</span>
                </>
              ) : (
                <>
            ...
            <p className="mt-6 text-xl leading-relaxed text-slate-300 max-w-2xl mx-auto">
              {isAr
      ...
      <section className="bg-transparent py-16 md:py-24 border-t border-white/10" id="faq">
        <div className="container-site max-w-3xl mx-auto">
          <FAQAccordion faqs={faqs} />

          <Reveal delay={0.4}>
            <div className="mt-16 bg-slate-900/60 backdrop-blur-xl border border-white/10 p-10 rounded-3xl text-center shadow-2xl">
