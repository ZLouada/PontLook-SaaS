...
const faqsAr = [
  { question: "ما الذي تقوم به منصة بونت لوك بالضبط؟", answer: "نساعد مزودي ومراكز تدريب الشركات في الوصول إلى صناع قرار موثوقين ومؤهلين في المنطقة ممن لديهم احتياج تدريبي فعلي واستعداد للتواصل." },
  ...
  { question: "هل يمكننا استهداف السعودية أو الإمارات فقط؟", answer: "نعم بالتأكيد. يمكننا تركيز الحملات على دولة محددة، أو مدن رئيسية كالرياض أو دبي، أو تغطية السوق الإقليمي الأوسع بحسب نطاق عملكم." },
