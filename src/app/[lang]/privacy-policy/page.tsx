...
export default async function PrivacyPolicyPage({ params }: { params: Promise<{ lang: Locale }> | { lang: Locale } }) {
  ...
  return (
    <>
      <section className="bg-transparent pt-32 pb-16 relative overflow-hidden">
        <div className="container-site max-w-4xl relative z-10 text-center mx-auto px-6">
          <Reveal>
            ...
            <h1 className="mt-6 text-4xl font-semibold sm:text-5xl lg:text-6xl text-white leading-tight font-heading">
              {isAr ? (
                <>
                  سياسة <span className="text-blue-400">الخصوصية</span>
                </>
              ) : (
                <>
      ...
      <section className="bg-transparent py-20 border-t border-white/10">
        <div className="container-site max-w-4xl mx-auto px-6">
          <Reveal>
            <div className="prose prose-slate max-w-none space-y-12 text-slate-300 leading-relaxed font-sans">
              <div className="bg-slate-900/60 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl">
                ...
                <p>
                  This Privacy Policy explains how we collect, use, disclose, and protect your personal information when you visit our website at <Link href={`/${lang}`} className="text-blue-400 hover:underline">pontlook.com</Link>, interact with our platform services, purchase products, or communicate with us.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="p-6 bg-slate-800/60 border border-white/10 rounded-2xl">
                    <h3 className="text-lg font-semibold text-white mb-2">California Residents (CCPA / CPRA)</h3>
                  ...
                  <div className="p-6 bg-slate-800/60 border border-white/10 rounded-2xl">
                    <h3 className="text-lg font-semibold text-white mb-2">European Economic Area (EEA) Residents (GDPR)</h3>
                    <ul className="list-disc pl-6 space-y-1 text-slate-300 text-sm">
              ...
              <div className="bg-blue-500/10 p-8 rounded-3xl border border-blue-500/20">
                ...
                <div className="text-slate-300 font-medium space-y-1 text-sm">
                  ...
                  <p>Email: <a href="mailto:contact@pontlook.com" className="text-blue-400 hover:underline">contact@pontlook.com</a></p>
                </div>
              </div>
            </div>
          </Reveal>
