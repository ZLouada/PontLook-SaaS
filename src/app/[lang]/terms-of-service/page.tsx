...
export default async function TermsOfServicePage({ params }: { params: Promise<{ lang: Locale }> | { lang: Locale } }) {
  const resolvedParams = await params;
        ...
        <div className="container-site max-w-4xl relative z-10 text-center mx-auto px-6">
          <Reveal>
            ...
            <h1 className="mt-6 text-4xl font-semibold sm:text-5xl lg:text-6xl text-white leading-tight font-heading tracking-[-0.03em]">
              {isAr ? (
                <>
                  شروط <span className="text-white">الخدمة والتعاقد</span>
                </>
              ) : (
                <>
          ...
          <Reveal>
            <div className="prose prose-invert max-w-none space-y-12 text-neutral-300 leading-relaxed font-sans">
              <div className="bg-[#0F1013] p-8 rounded-2xl sm:rounded-3xl border border-[#26282D]">
                ...
                <p>
                  PontLook is a B2B corporate training matchmaking platform designed to identify enterprise organizations with active workforce challenges and connect them with qualified corporate training providers. By accessing or using our platform, you agree to be bound by these Terms and our <Link href={`/${lang}/privacy-policy`} className="text-white hover:underline underline-offset-4">Privacy Policy</Link>.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-neutral-400">
                  ...
                  <li>Promptly notify us at <a href="mailto:contact@pontlook.com" className="text-white underline underline-offset-4 hover:text-neutral-300">contact@pontlook.com</a> if you suspect any security breach or unauthorized use.</li>
              ...
              <div className="bg-[#0F1013] p-8 rounded-2xl sm:rounded-3xl border border-[#26282D]">
                ...
                <ul className="list-disc pl-6 space-y-3 text-neutral-400">
                  <li>
                    <strong className="text-white">Payment Methods:</strong> You authorize PontLook and its designated payment processors (including Fourthwall, credit card networks, and PayPal) to charge your selected payment method for all agreed fees and applicable taxes.
                  </li>
                  <li>
                    <strong className="text-white">Fee Schedule:</strong> Fees for lead packages or services are specified at the time of order confirmation or in your executed provider agreement.
                  </li>
                  <li>
                    <strong className="text-white">No Retainers:</strong> Services are billed strictly based on delivered and qualified leads or approved transactions; no ongoing monthly setup fees apply unless explicitly agreed in writing.
                  </li>
                  <li>
                    <strong className="text-white">Late Payments:</strong> Unpaid invoices may incur late interest at the rate of 1.5% per month or the maximum rate permitted by applicable law.
                  </li>
                </ul>
              </div>
