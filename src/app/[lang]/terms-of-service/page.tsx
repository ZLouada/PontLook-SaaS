        ...
        <div className="container-site max-w-4xl relative z-10 text-center mx-auto px-6">
          <Reveal>
            ...
            <h1 className="mt-6 text-4xl font-semibold sm:text-5xl lg:text-6xl text-white leading-tight font-heading">
              {isAr ? (
                <>
                  شروط <span className="text-blue-400">الخدمة والتعاقد</span>
                </>
              ) : (
                <>
          ...
          <Reveal>
            <div className="prose prose-slate max-w-none space-y-12 text-slate-300 leading-relaxed font-sans">
              <div className="bg-slate-900/60 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl">
                ...
                <p>
                  PontLook is a B2B corporate training matchmaking platform designed to identify GCC organizations with active workforce challenges and connect them with qualified corporate training providers. By accessing or using our platform, you agree to be bound by these Terms and our <Link href={`/${lang}/privacy-policy`} className="text-blue-400 hover:underline">Privacy Policy</Link>.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-slate-300">
                  ...
                  <li>Promptly notify us at <a href="mailto:contact@pontlook.com" className="text-blue-400 hover:underline">contact@pontlook.com</a> if you suspect any security breach or unauthorized use.</li>
