...
export default async function ReturnsFAQPage({ params }: { params: Promise<{ lang: Locale }> | { lang: Locale } }) {
  ...
  return (
    <>
        ...
        <div className="container-site max-w-4xl relative z-10 text-center mx-auto px-6">
          <Reveal>
            ...
            <h1 className="mt-6 text-4xl font-semibold sm:text-5xl lg:text-6xl text-white leading-tight font-heading">
              {isAr ? (
                <>
                  سياسة الاسترجاع <span className="text-blue-400">والأسئلة الشائعة</span>
                </>
              ) : (
                <>
                  Returns &amp; FAQ <span className="text-blue-400">Policy</span>
                </>
              )}
            </h1>
      ...
      <section className="bg-transparent py-12 border-t border-white/10">
            ...
            {policyHighlights.map((item, index) => {
              ...
              return (
                <Reveal key={index} delay={index * 0.08}>
                  <div className="p-6 rounded-2xl bg-slate-900/60 backdrop-blur-xl border border-white/10 shadow-xl h-full flex flex-col justify-between">
                    <div>
        ...
        <div className="container-site max-w-4xl mx-auto px-6">
          <Reveal>
            <div className="prose prose-slate max-w-none space-y-12 text-slate-300 leading-relaxed font-sans">
              ...
              <div>
                ...
                <div className="p-6 bg-blue-500/10 border border-blue-500/20 rounded-2xl">
                  ...
                  <ol className="list-decimal pl-6 space-y-2 text-slate-300 text-sm">
                    <li>Contact our support team within <strong>30 days of delivery</strong> at <a href="mailto:contact@pontlook.com" className="text-blue-400 hover:underline">contact@pontlook.com</a>.</li>
              ...
              <div className="bg-blue-500/10 p-8 rounded-3xl border border-blue-500/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                <div>
                ...
                <Link
                  href={`/${lang}/contact`}
                  className="btn-primary inline-flex items-center gap-2 text-sm shrink-0 px-6 py-3 rounded-full shadow-xl"
                >
                  <Mail size={16} />
                  Contact Support
                </Link>
